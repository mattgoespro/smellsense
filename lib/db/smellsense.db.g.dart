  ...
  Future<sqflite.Database> open(
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `TrainingPeriodEntity` (`id` TEXT NOT NULL, `start_date` TEXT NOT NULL, PRIMARY KEY (`id`))');
        await database.execute(
  ...
  _$TrainingPeriodDao(
    ...
    this.changeListener,
        ...
        _trainingPeriodEntityInsertionAdapter = InsertionAdapter(
            ...
            (TrainingPeriodEntity item) =>
                <String, Object?>{'id': item.id, 'start_date': item.startDate},
            changeListener),
  ...
  Stream<List<TrainingPeriodEntity>> listTrainingPeriods() {
    return _queryAdapter.queryListStream(
        ...
        mapper: (Map<String, Object?> row) => TrainingPeriodEntity(
            id: row['id'] as String, startDate: row['start_date'] as String),
